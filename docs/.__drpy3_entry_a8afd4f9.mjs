...
export default {
    meta: {
        title: '百忙无果[官]',
        host: 'http://127.0.0.1:19772',
        searchable: 2, filterable: 1, quickSearch: 0, multi: 1,
    },
    rule: {
        searchUrl: 'http://127.0.0.1:19772/msite/search/v2?q=**&pn=fypage&pc=10',
        detailUrl: 'http://127.0.0.1:19772/episode/list?page=1&size=50&video_id=fyid',
    ...
    async search(ctx, wd, quick, pg) {
        ...
        const res = await request(
            ...
            { headers: { 'User-Agent': 'MOBILE_UA', Referer: 'http://127.0.0.1:19772' } },
        );
        const list = [];
